...
<form id="productForm" action="{{ route('products.update', $product->id) }}" method="POST" class="row g-3 mt-3">
      ...
      <div class="col-md-4">
        ...
        <input type="text" class="form-control" name="hsn_code" id="hsn_code" value="{{$product->hsn_code}}">
      </div>
      <div class="col-md-4">
    ...
    <select class="form-select" name="business_location" id="business_location">
        ...
        @foreach($business as $biz)
            ...
            <option value="{{ $biz->id }}"
                {{ $product->business_location == $biz->id ? 'selected' : '' }}>
      ...
      <div class="col-md-4">
        ...
        <input type="text" class="form-control" name="alert_quantity" id="alert_quantity" value="{{$product->alert_quantity}}">
      </div>
      <div class="col-md-4">
        <label class="form-label">Opening Stock:</label>
        <input type="text" class="form-control" name="opening_stock" id="opening_stock" value="{{$product->opening_stock}}">
    </div>
       <div class="col-md-4">
